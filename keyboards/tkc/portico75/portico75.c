...
const is31_led PROGMEM g_is31_leds[DRIVER_LED_TOTAL] = {
    {0, CS18_SW1, CS17_SW1, CS16_SW1}, //0
    ...
    {0, CS21_SW1, CS20_SW1, CS19_SW1}, //9
    ...
    {0, CS15_SW1, CS14_SW1, CS13_SW1}, //15
    ...
    {0, CS24_SW1, CS23_SW1, CS22_SW1}, //24
    ...
    {0, CS12_SW1, CS11_SW1, CS10_SW1}, //30
    ...
    {0, CS12_SW9, CS11_SW9, CS10_SW9}, //38

    {0, CS27_SW1, CS26_SW1, CS25_SW1}, //39
    {0, CS27_SW2, CS26_SW2, CS25_SW2},
    {0, CS27_SW3, CS26_SW3, CS25_SW3},
    {0, CS27_SW4, CS26_SW4, CS25_SW4},
    {0, CS27_SW5, CS26_SW5, CS25_SW5},
    {0, CS27_SW6, CS26_SW6, CS25_SW6}, //44

    {0, CS9_SW1, CS8_SW1, CS7_SW1}, //45
    ...
    {0, CS9_SW9, CS8_SW9, CS7_SW9}, //53

    {0, CS30_SW1, CS29_SW1, CS28_SW1}, //54
    {0, CS30_SW2, CS29_SW2, CS28_SW2},
    {0, CS30_SW3, CS29_SW3, CS28_SW3},
    {0, CS30_SW4, CS29_SW4, CS28_SW4}, //57

    {0, CS6_SW1, CS5_SW1, CS4_SW1}, //58
...
led_config_t g_led_config = { {
    ...
    // Underglow
    {2,0},{46,0},{90,0},{134,0},{178,0},{222,0}, //top
    {0,2},{0,32},{0,62}, //left
